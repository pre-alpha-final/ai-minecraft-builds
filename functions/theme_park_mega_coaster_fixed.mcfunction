...
# Run with /function mega_coaster on flat ground while facing a cardinal direction and looking horizontally.
# Your feet are the build origin; coordinates use ^left, ^up, ^forward.
# Approximate footprint: local left -4..98, local up -1..40, local forward -22..52.
...
# -- NEGATIVE LOCAL-FORWARD TURN --
setblock ^15 ^5 ^50 minecraft:rail
# -- NEGATIVE LOCAL-FORWARD RUN --
...
# -- NEGATIVE LOCAL-LEFT TURN --
setblock ^15 ^5 ^-20 minecraft:rail
# -- NEGATIVE LOCAL-LEFT RETURN --
...
# -- POSITIVE LOCAL-FORWARD TURN --
setblock ^ ^5 ^-20 minecraft:rail
# -- POSITIVE LOCAL-FORWARD RETURN --
...
# Build complete. Place a minecart on the station track and ride toward local left.
