...
# Origin: run the function from the CENTER of the attraction at ground level.
# The ship is deliberately built at a mid-swing angle.
# Commands use relative coordinates, so the attraction can be placed anywhere.
...
# The positive X end is the raised dragon-head bow.
